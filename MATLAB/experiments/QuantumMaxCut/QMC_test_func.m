function e = QMC_test_func(w, A, varargin)
...
%    
    [QAOAhelperfcn, HamObj, HamC, HamZ, HamB, HamD, EvolC, EvolZ, EvolB, EvolD] = SetupQMCHams(N, J, ones(N,1), cell2mat(varargin));
